...
style="width: 15px; height: 15px; display:inline;" name="gender" value="1" checked/>&nbsp;Male&nbsp;<input type="radio" style="width: 15px; height: 15px;   display: inline;" name="gender" value="0"/>&nbsp;Female</span>
   <span></span>
