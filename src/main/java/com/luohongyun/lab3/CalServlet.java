...
public class CalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(action.equals("add") || action.equals("subtarat") || action.equals("multiply") || action.equals("divide")){
            ...
            resp.addCookie(new jakarta.servlet.http.Cookie("cFirstVal", firstVal));
            resp.addCookie(new jakarta.servlet.http.Cookie("cSecondVal", secondVal));
            resp.addCookie(new jakarta.servlet.http.Cookie("cResult", String.valueOf(result)));
        }
        ...
        if(action.equals("computerLength")){
            ...
            resp.addCookie(new jakarta.servlet.http.Cookie("cName", cName));
            resp.addCookie(new jakarta.servlet.http.Cookie("cLength", String.valueOf(computeLength(cName))));
        }
